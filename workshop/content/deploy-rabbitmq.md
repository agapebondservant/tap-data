...
Apply the following to enable Wavefront integration:
```execute
...
Next, let's deploy a RabbitMQ **instance**. Here is the manifest:
```editor:open-file
